...
public class ChatClient {
    ...
    //GET host:port/chat/clearchat
    public static Response clearChat() throws IOException {
        Request request = new Request.Builder()
                .get()
    ...
    //GET host:port/chat/stat
    public static Response viewStat() throws IOException {
        Request request = new Request.Builder()
                .get()
                .url(PROTOCOL + HOST + PORT + "/chat/stat")
                .addHeader("host", HOST + PORT)
                .build();
        return client.newCall(request).execute();
    }
